                                                ...
                                                <div key={i} className="col-lg-6 p-1">
                                                    {v.selected &&
                                                        <div className="p-4 bg-white rounded">
                                                            <SimpleSingleAreaChart anomalyDataByTime={anomalyDataByTime} title={v.name} data={minorChartData[i]} height={this.state.height}/>
                                                        </div>
                                                    }
                                                </div>
                                            )
                                        ...
                                        </div>
                                        {
                                            graphShowData.map((v, i) =>
                                                <div key={i} className="pt-2 ">
                                                    {v.selected &&
                                                        <div className="p-4 bg-white rounded" >
                                                            <SimpleSingleAreaChart anomalyDataByTime={anomalyDataByTime} title={v.name} data={minorChartData[i]} />
                                                        </div>
                                                    }
                                                </div>
                                            )
